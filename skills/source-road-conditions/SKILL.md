...
With any hourly forecast (temperature, precipitation probability) and any alert feed (Winter
Storm Warning, Ice Storm Warning, Winter Weather Advisory, Flood Warning, Dense Fog Advisory), an
app can show **"road risk"** — freezing temperature + precipitation ⇒ ice risk; active winter/fog
