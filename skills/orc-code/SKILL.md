...
| App | web only | React (Vite, TypeScript) + FastAPI | Next.js (front, or Node back end); Django; PHP (back end, when the host serves PHP and nothing else) | `skills/stack-web/SKILL.md` — read it in full before scaffolding; PHP: `skills/stack-php/SKILL.md` |
